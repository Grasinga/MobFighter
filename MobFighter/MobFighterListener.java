...
class MobFighterListener implements Listener {
    ...
    static ArrayList<BlockState> blockStates = new ArrayList<BlockState>();
    static int fixBlockDelay = 0;

    // Constructor to pass in important variables.
    MobFighterListener(JavaPlugin p){
        mobfighter = p;
    ...
    public void logIn(PlayerLoginEvent e)
    {
        ...
        try{p.setMaxHealth(mobfighter.getConfig().getDouble("HealthBoost." + p.getDisplayName()));}
