...
class MainShop {
    ...
    static
    {
        ...
        stoneSwordMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("STONE_SWORD")));
        ...
        leatherHatMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("LEATHER_HELMET")));
        ...
        leatherChestMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("LEATHER_CHESTPLATE")));
        ...
        leatherLegsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("LEATHER_LEGGINGS")));
        ...
        leatherBootsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("LEATHER_BOOTS")));
        leatherBoots.setItemMeta(leatherBootsMeta);
        shopInv.setItem(36, leatherBoots);

        ItemStack bow = new ItemStack(Material.BOW);
        ItemMeta bowMeta = bow.getItemMeta();
        bowMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("BOW")));
        ...
        goldSwordMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_SWORD")));
        ...
        goldHatMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_HELMET")));
        ...
        goldChestMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_CHESTPLATE")));
        ...
        goldLegsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_LEGGINGS")));
        ...
        goldBootsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_BOOTS")));
        goldBoots.setItemMeta(goldBootsMeta);
        shopInv.setItem(37, goldBoots);

        ItemStack arrow = new ItemStack(Material.ARROW,16);
        ItemMeta arrowMeta = arrow.getItemMeta();
        arrowMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("ARROW")));
        arrow.setItemMeta(arrowMeta);
        shopInv.setItem(46, arrow);

        ItemStack ironSword = new ItemStack(Material.IRON_SWORD);
        ItemMeta ironSwordMeta = ironSword.getItemMeta();
        ironSwordMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_SWORD")));
        ...
        ironHatMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_HELMET")));
        ...
        ironChestMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_CHESTPLATE")));
        ...
        ironLegsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_LEGGINGS")));
        ironLegs.setItemMeta(ironLegsMeta);
        shopInv.setItem(29, ironLegs);

        ItemStack ironBoots = new ItemStack(Material.IRON_BOOTS);
        ItemMeta ironBootsMeta = ironBoots.getItemMeta();
        ironBootsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_BOOTS")));
        ...
        beefMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("COOKED_BEEF")));
        beef.setItemMeta(beefMeta);
        shopInv.setItem(47, beef);

        ItemStack diamondSword = new ItemStack(Material.DIAMOND_SWORD);
        ItemMeta diamondSwordMeta = diamondSword.getItemMeta();
        diamondSwordMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND_SWORD")));
        ...
        diamondHatMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND_HELMET")));
        ...
        diamondChestMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND_CHESTPLATE")));
        ...
        diamondLegsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND_LEGGINGS")));
        ...
        diamondBootsMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND_BOOTS")));
        ...
        appleMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("APPLE")));
        ...
        bookMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("BOOK")));
        ...
        expBottleMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("EXP_BOTTLE")));
        ...
        pot1Meta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("POTION")));
        ...
        pot2Meta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("POTION")));
        ...
        pot3Meta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("POTION")));
        ...
        pot4Meta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("POTION")));
        ...
        goldMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("GOLD_INGOT")));
        gold.setItemMeta(goldMeta);
        shopInv.setItem(51, gold);

        ItemStack iron = new ItemStack(Material.IRON_INGOT,10);
        ItemMeta ironMeta = iron.getItemMeta();
        ironMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("IRON_INGOT")));
        iron.setItemMeta(ironMeta);
        shopInv.setItem(52, iron);

        ItemStack diamond = new ItemStack(Material.DIAMOND,10);
        ItemMeta diamondMeta = diamond.getItemMeta();
        diamondMeta.setLore(Collections.singletonList(ChatColor.AQUA + "Price: $" + shop.getString("DIAMOND")));
